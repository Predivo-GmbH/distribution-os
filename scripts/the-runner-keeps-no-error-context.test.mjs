 ...
 *
 * app/e2e/strip-runner-artifacts.reporter.ts closes that. This asserts it closes it, because the only
...
const CONFIG_ROOT = resolve(HERE, '..', 'app')
const REPORTER_FILE = resolve(HERE, '..', 'app', 'e2e', 'strip-runner-artifacts.reporter.ts')
