  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-[var(--color-surface)] border border-[var(--color-edge)] rounded-xl overflow-hidden">
        <div className="px-5 py-3 border-b border-[var(--color-edge)]">
        ...
        <div className="divide-y divide-[var(--color-edge)]">
          {config.schedules.map((schedule, idx) => {
            ...
            return (
              <div key={schedule.workerType} className="px-5 py-4">
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-4 mt-1.5 text-xs text-[var(--color-ink-muted)]">
                  ...
                  <div className="flex items-center gap-3 shrink-0">
                    ...
                    <input
                      ...
                      className="px-2 py-1 rounded border border-[var(--color-edge-outline)] bg-[var(--color-surface)] text-xs text-[var(--color-ink)] focus:outline-none focus:border-[var(--color-edge-focus)]"
                    />
