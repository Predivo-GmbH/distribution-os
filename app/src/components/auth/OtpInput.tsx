    ...
    <div className="flex justify-center gap-2.5" role="group" aria-label="Verification code">
      {Array.from({ length }, (_, i) => (
        <input
          ...
          className="h-14 w-10 sm:w-12 rounded-lg border-2 border-white/[0.15] bg-white/[0.06] text-center text-2xl font-bold text-white transition-all focus:border-indigo-500/50 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 disabled:opacity-50"
        />
      ))}
    </div>
  )
